...
const TemperatureMonitorChart = dynamic(() => import("./TemperatureMonitorChart"), { ssr: false });

export default async function Case010Page() {
  const item = await fetchCase("case-010");
  if (!item) notFound();
